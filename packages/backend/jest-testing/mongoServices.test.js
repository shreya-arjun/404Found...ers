...
import { addUser, findUser, removeUser, addSuggestion, findSuggestions } from "../services/mongoServices.js";
...
test("Returns suggestions given a spotify ID", async () => {
    const user = { spotifyId: "abc123", suggestions: ["Hello, I'm a suggestion :)"] };
...
test("Saves new suggestion", async () => {
    const suggestion = { text: "This is a song you should listen to because you are very sad", user: "abc123" };
